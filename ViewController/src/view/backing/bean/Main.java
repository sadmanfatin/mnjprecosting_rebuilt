...
//    }
    ...
    public String sendForApproval() {
       ...
       String costingMismatchStatus = null;
        costingMismatchStatus = checkCostingMismatchStatus();
        
     
            
            if ( !costingMismatchStatus.equals("OK" )  ){
                this.showMessage(costingMismatchStatus, "error");
...
//                }
    ...
    private String checkCostingMismatchStatus() {
       ...
       // System.out.println("---------------- in checkCostingMismatchStatus()");
        ...
        String status = null  ;
         java.sql.CallableStatement cs =am.getDBTransaction().createCallableStatement(functionStatement, 1);
         
        try {
            cs.registerOutParameter(1, OracleTypes.VARCHAR);
            cs.setString(2, currentHeaderId);
            cs.execute();
     ...
     // System.out.println("---------------- checkCostingMismatchStatus(). status "+ status );
        return status;
    }
